  ...
  useEffect(() => {
    const $ = {
      ...
      datGui() {
        ...
        gui.add(_this.params, 'vertexColors').name('顶点颜色').onChange((value)=>{
          _this.point.material.vertexColors = value;
          _this.point.material.needsUpdate = true;
        });
        gui.add(_this.params, 'particles', 1, 500000, 1).name('粒子数量').onChange((value)=>{
          // 先销毁旧的粒子 
