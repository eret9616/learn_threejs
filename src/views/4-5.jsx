  ...
  useEffect(() => {
    const $ = {
      ...
      loadTextures() {
        ...
        let texture = textureLoader.load('src/assets/textures/sword.png');

        let sword = textureLoader.load('src/assets/textures/sword.png');
      ...
      createCamera() {
        ...
        pCamera.position.set(0, 1, 3); // x,y,z
