...
const Page = () => {
  useEffect(() => {
    const $ = {
      ...
      poiner: new THREE.Vector2(),
      tick() {
        // 更新射线
        this.raycaster.setFromCamera(this.poiner, this.camera);
        // 获取场景中所有与鼠标交互的物体
      ...
      init() {
        ...
        window.addEventListener('mousemove', (e) => {
          this.poiner.x = (e.clientX / window.innerWidth) * 2 - 1; // 0-2
          this.poiner.y = -(e.clientY / window.innerHeight) * 2 + 1; // -1 1
          //1
