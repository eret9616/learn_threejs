...
const Page = () => {
  useEffect(() => {
    const $ = {
      ...
      createMeshes(mapcapTexture, z = 1) {
      ...
      createObjects() {
        ...
        for (let i = 0; i < 300; i++) {
          this.createMeshes(mapcapTexture, 1); // 室内的物体
          this.createMeshes(mapcapTexture, -1); // 室外的物体
        }
      ...
      datGui() {
        ...
        fogFolder.add(_this.scene.fog, 'density', 0, 0.5, 0.01);
      },
      helpers() {
        // 创建辅助坐标系
