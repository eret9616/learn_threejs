  ...
  useEffect(() => {
    const $ = {
      ...
      loadTextures() {
        ...
        texture.wrapS = THREE.RepeatWrapping; // 默认值
        // 默认值 ClampToEdgeWrapping 阵列：RepeatWrapping 镜像：MirroredRepeatWrapping
        texture.wrapT = THREE.RepeatWrapping;
        // texture.offset = new THREE.Vector2(0.5, 0.5); // 偏移
        texture.rotation = Math.PI / 12; // 旋转 正值：逆时针 负值：顺时针
        texture.center.set(0.5, 0.5); // 0 0是左下角
      ...
      createCamera() {
        ...
        pCamera.position.set(0, 0, 4); // x,y,z
      ...
      datGui() {
        ...
        gui.add(_this.texture.center, 'y', 0, 1, 0.1).name('centerX');
      },
      helpers() {
